...
class CommonConstants {
    ...
    static let BASE_SERVER_HOST = "https://mybiosp.aware.com:1443/BioSP/rest"
    static let serviceUsername = "knomi"
    static let servicePassword = "FGDF43235!"
    ...
    static let DOC_TYPE_VALIDATION_URL = DOC_AUTH_SERVICE_BASE + "/validateDocumentType"
